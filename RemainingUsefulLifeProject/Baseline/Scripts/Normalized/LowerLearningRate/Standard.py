...
from RemainingUsefulLifeProject.Baseline.Models.FNNs.LowLearningRate import FFNModel
...
def write_gathered_scores(scores, title="Scores Baseline"):
    folders = "Results", "FeedForward Neural Network", "Low Learning Rate", "Standard"
...
def save_results(y_true, y_pred, trained_on="", tested_on="", new_file=True):
    folders = "Images", "Feedforward Neural Networks", "Low Learning Rate", "Standard"
